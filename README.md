...
Attachment object consists of the following properties:
  ...
  - **cid** - optional content id for using inline images in HTML message source. If you do not want to use a cid, set this value as `false`, otherwise a random cid is generated automatically
