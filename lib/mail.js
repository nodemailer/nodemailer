...
function EmailMessage(params){
    ...
    this.charset = params.charset || "ISO-8859-1";  // Changed 5/24/2011.
    this.encoding = params.encoding || "7bit";      // Added 5/24/2011.
...
EmailMessage.prototype.generateBody = function(){
    ...
    for(var i=0; i<this.attachments.length; i++){
        ...
        /* Changed 5/26/2011; removed the addition of \r\n characters. */
        rows.push(current.contents.toString("base64"));
