...
function EmailMessage(params){
    ...
    this.charset = "ISO-8859-1";  // Changed from UTF-8; 5/23/2011.
...
EmailMessage.prototype.prepareVariables = function(){
    ...
    //'?' is not in any known base64 extension
        ...
        this.content_transfer_encoding = "7bit";  // Changed from quoted-printable; 5/23/2011.
    }
}
...
EmailMessage.prototype.generateBody = function(){
    ...
    rows.push("Content-Transfer-Encoding: 7bit"); // Changed from quoted-printable; 5/23/2011.
    rows.push("");
