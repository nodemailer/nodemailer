...
module.exports.createTransport = function(type, options){
    ...
    if(options && type.toUpperCase() === "SENDMAIL"){
        noCR = !!options.noCR;
    }
...
Nodemailer.prototype.generateMailObject = function(){
    ...
    // setup dsn
    if (this.options.dsn!==undefined){
        this.mailcomposer.options.dsn = {
            delay: this.options.dsn.delay || false,
            success: this.options.dsn.success || false,
            failure: this.options.dsn.failure || false
        };
    }else{
        this.mailcomposer.options.dsn = {};
    }
