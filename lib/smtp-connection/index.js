...
class SMTPConnection extends EventEmitter {
    ...
    _setEnvelope(envelope, callback) {
        ...
        // RFC 8689: If the server supports REQUIRETLS and the envelope requests it
        // then append REQUIRETLS keyword to the MAIL FROM command
        // Note: REQUIRETLS can only be used over TLS connections
        if (this._envelope.requireTLS && this._supportedExtensions.includes('REQUIRETLS')) {
            if (!this.secure) {
                return callback(
