...
const familySupportCache = new Map();
const isFamilySupported = (family, allowInternal) => {
    const cacheKey = family + ':' + (allowInternal ? '1' : '0');
    if (familySupportCache.has(cacheKey)) {
        return familySupportCache.get(cacheKey);
    }
    ...
    familySupportCache.set(cacheKey, result);
    return result;
};
